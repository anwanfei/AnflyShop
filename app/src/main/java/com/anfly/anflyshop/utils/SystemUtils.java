package com.anfly.anflyshop.utils;
...
public class SystemUtils {
    ...
    public static boolean checkNetWork(){
        ConnectivityManager manager = (ConnectivityManager) AnflyApplication.getAnflyApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
